...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@635eaaf1
    m_timestamp_ = 0;
    // m_ind_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5c30a9b0
    m_ind_ = 0;
    // m_value_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1ddf84b8
    m_value_ = 0.0;
