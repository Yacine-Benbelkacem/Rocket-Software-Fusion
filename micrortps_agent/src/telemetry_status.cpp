...
telemetry_status::telemetry_status()
{
    ...
    // m_heartbeat_component_telemetry_radio_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@59fd97a8
    m_heartbeat_component_telemetry_radio_ = false;
    // m_heartbeat_component_log_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f5ac9e4
    m_heartbeat_component_log_ = false;
    // m_heartbeat_component_osd_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@123ef382
    m_heartbeat_component_osd_ = false;
    // m_heartbeat_component_obstacle_avoidance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@dbf57b3
    m_heartbeat_component_obstacle_avoidance_ = false;
    // m_heartbeat_component_vio_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@384ad17b
    m_heartbeat_component_vio_ = false;
    // m_heartbeat_component_pairing_manager_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@61862a7f
    m_heartbeat_component_pairing_manager_ = false;
    // m_heartbeat_component_udp_bridge_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@441772e
    m_heartbeat_component_udp_bridge_ = false;
    // m_heartbeat_component_uart_bridge_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7334aada
    m_heartbeat_component_uart_bridge_ = false;
    // m_avoidance_system_healthy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1d9b7cce
