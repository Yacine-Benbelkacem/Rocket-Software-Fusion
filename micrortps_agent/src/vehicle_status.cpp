...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@188715b5
    m_timestamp_ = 0;
    // m_nav_state_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1ea9f6af
    m_nav_state_ = 0;
    // m_nav_state_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a192cfe
    m_nav_state_timestamp_ = 0;
    // m_arming_state_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5119fb47
    m_arming_state_ = 0;
    // m_hil_state_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7193666c
    m_hil_state_ = 0;
    // m_failsafe_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@20deea7f
    m_failsafe_ = false;
    // m_failsafe_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3835c46
    m_failsafe_timestamp_ = 0;
    // m_system_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1dde4cb2
    m_system_type_ = 0;
    // m_system_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7714e963
    m_system_id_ = 0;
    // m_component_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@20ce78ec
    m_component_id_ = 0;
    // m_vehicle_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@393671df
    m_vehicle_type_ = 0;
    // m_is_vtol_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@56620197
    m_is_vtol_ = false;
    // m_is_vtol_tailsitter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6eda5c9
    m_is_vtol_tailsitter_ = false;
    // m_vtol_fw_permanent_stab_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55b7a4e0
    m_vtol_fw_permanent_stab_ = false;
    // m_in_transition_mode_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5f058f00
    m_in_transition_mode_ = false;
    // m_in_transition_to_fw_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1afd44cb
    m_in_transition_to_fw_ = false;
    // m_rc_signal_lost_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@498d318c
    m_rc_signal_lost_ = false;
    // m_rc_input_mode_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6e171cd7
    m_rc_input_mode_ = 0;
    // m_data_link_lost_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@402bba4f
    m_data_link_lost_ = false;
    // m_data_link_lost_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@795cd85e
    m_data_link_lost_counter_ = 0;
    // m_high_latency_data_link_lost_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@59fd97a8
    m_high_latency_data_link_lost_ = false;
    // m_engine_failure_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f5ac9e4
    m_engine_failure_ = false;
    // m_mission_failure_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@123ef382
    m_mission_failure_ = false;
    // m_geofence_violated_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@dbf57b3
    m_geofence_violated_ = false;
    // m_failure_detector_status_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@384ad17b
    m_failure_detector_status_ = 0;
    // m_onboard_control_sensors_present_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@61862a7f
    m_onboard_control_sensors_present_ = 0;
    // m_onboard_control_sensors_enabled_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@441772e
    m_onboard_control_sensors_enabled_ = 0;
    // m_onboard_control_sensors_health_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7334aada
    m_onboard_control_sensors_health_ = 0;
    // m_latest_arming_reason_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1d9b7cce
    m_latest_arming_reason_ = 0;
    // m_latest_disarming_reason_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4d9e68d0
    m_latest_disarming_reason_ = 0;
    // m_armed_time_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@42e99e4a
    m_armed_time_ = 0;
    // m_takeoff_time_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@14dd9eb7
    m_takeoff_time_ = 0;
