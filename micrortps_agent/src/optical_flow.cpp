...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@50eac852
    m_timestamp_ = 0;
    // m_sensor_id_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@16ec5519
    m_sensor_id_ = 0;
    // m_pixel_flow_x_integral_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2f7298b
    m_pixel_flow_x_integral_ = 0.0;
    // m_pixel_flow_y_integral_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@188715b5
    m_pixel_flow_y_integral_ = 0.0;
    // m_gyro_x_rate_integral_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1ea9f6af
    m_gyro_x_rate_integral_ = 0.0;
    // m_gyro_y_rate_integral_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6a192cfe
    m_gyro_y_rate_integral_ = 0.0;
    // m_gyro_z_rate_integral_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5119fb47
    m_gyro_z_rate_integral_ = 0.0;
    // m_ground_distance_m_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7193666c
    m_ground_distance_m_ = 0.0;
    // m_integration_timespan_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@20deea7f
    m_integration_timespan_ = 0;
    // m_time_since_last_sonar_update_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3835c46
    m_time_since_last_sonar_update_ = 0;
    // m_frame_count_since_last_readout_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1dde4cb2
    m_frame_count_since_last_readout_ = 0;
    // m_gyro_temperature_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7714e963
    m_gyro_temperature_ = 0;
    // m_quality_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@20ce78ec
    m_quality_ = 0;
    // m_max_flow_rate_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@393671df
    m_max_flow_rate_ = 0.0;
    // m_min_ground_distance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@56620197
    m_min_ground_distance_ = 0.0;
    // m_max_ground_distance_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5f058f00
    m_max_ground_distance_ = 0.0;
    // m_mode_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@333291e3
    m_mode_ = 0;
