...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1623b78d
    m_timestamp_ = 0;
    // m_position com.eprosima.idl.parser.typecode.AliasTypeCode@c8c12ac
    memset(&m_position, 0, (3) * 4);
    // m_velocity com.eprosima.idl.parser.typecode.AliasTypeCode@c8c12ac
    memset(&m_velocity, 0, (3) * 4);
    // m_acceleration com.eprosima.idl.parser.typecode.AliasTypeCode@c8c12ac
    memset(&m_acceleration, 0, (3) * 4);
    // m_yaw_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6adbc9d
    m_yaw_ = 0.0;
    // m_yaw_speed_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4550bb58
    m_yaw_speed_ = 0.0;
    // m_point_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4ec4f3a0
    m_point_valid_ = false;
    // m_type_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@223191a6
    m_type_ = 0;
