...
{
    // m_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@74f0ea28
    m_timestamp_ = 0;
    // m_timestamp_sample_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@f6efaab
    m_timestamp_sample_ = 0;
    // m_xy_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3c19aaa5
    m_xy_valid_ = false;
    // m_z_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3349e9bb
    m_z_valid_ = false;
    // m_v_xy_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@409bf450
    m_v_xy_valid_ = false;
    // m_v_z_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@38d8f54a
    m_v_z_valid_ = false;
    // m_x_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@49e53c76
    m_x_ = 0.0;
    // m_y_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@351d00c0
    m_y_ = 0.0;
    // m_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2a3b5b47
    m_z_ = 0.0;
    // m_delta_xy com.eprosima.idl.parser.typecode.AliasTypeCode@55b699ef
    memset(&m_delta_xy, 0, (2) * 4);
    // m_xy_reset_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@35d019a3
    m_xy_reset_counter_ = 0;
    // m_delta_z_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@689604d9
    m_delta_z_ = 0.0;
    // m_z_reset_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@18078bef
    m_z_reset_counter_ = 0;
    // m_vx_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@799f10e1
    m_vx_ = 0.0;
    // m_vy_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4c371370
    m_vy_ = 0.0;
    // m_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@313ac989
    m_vz_ = 0.0;
    // m_z_deriv_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4135c3b
    m_z_deriv_ = 0.0;
    // m_delta_vxy com.eprosima.idl.parser.typecode.AliasTypeCode@55b699ef
    memset(&m_delta_vxy, 0, (2) * 4);
    // m_vxy_reset_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5c6648b0
    m_vxy_reset_counter_ = 0;
    // m_delta_vz_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6f1de4c7
    m_delta_vz_ = 0.0;
    // m_vz_reset_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@459e9125
    m_vz_reset_counter_ = 0;
    // m_ax_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@128d2484
    m_ax_ = 0.0;
    // m_ay_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7cc0cdad
    m_ay_ = 0.0;
    // m_az_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7c7b252e
    m_az_ = 0.0;
    // m_heading_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4d5d943d
    m_heading_ = 0.0;
    // m_delta_heading_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@368f2016
    m_delta_heading_ = 0.0;
    // m_heading_reset_counter_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4c583ecf
    m_heading_reset_counter_ = 0;
    // m_xy_global_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@692f203f
    m_xy_global_ = false;
    // m_z_global_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@48f2bd5b
    m_z_global_ = false;
    // m_ref_timestamp_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7b2bbc3
    m_ref_timestamp_ = 0;
    // m_ref_lat_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@a1153bc
    m_ref_lat_ = 0.0;
    // m_ref_lon_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1aafa419
    m_ref_lon_ = 0.0;
    // m_ref_alt_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@47eaca72
    m_ref_alt_ = 0.0;
    // m_dist_bottom_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55141def
    m_dist_bottom_ = 0.0;
    // m_dist_bottom_valid_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55182842
    m_dist_bottom_valid_ = false;
    // m_dist_bottom_sensor_bitfield_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@3270d194
    m_dist_bottom_sensor_bitfield_ = 0;
    // m_eph_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@235834f2
    m_eph_ = 0.0;
    // m_epv_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5656be13
    m_epv_ = 0.0;
    // m_evh_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4218d6a3
    m_evh_ = 0.0;
    // m_evv_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@76505305
    m_evv_ = 0.0;
    // m_vxy_max_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@14cd1699
    m_vxy_max_ = 0.0;
    // m_vz_max_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77888435
    m_vz_max_ = 0.0;
    // m_hagl_min_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@73a1e9a9
    m_hagl_min_ = 0.0;
    // m_hagl_max_ com.eprosima.idl.parser.typecode.PrimitiveTypeCode@71d44a3
    m_hagl_max_ = 0.0;
