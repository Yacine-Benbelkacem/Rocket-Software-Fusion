...
/*!
 * @file actuator_controlsPubSubTypes.h
...
#ifndef _ACTUATOR_CONTROLS_PUBSUBTYPES_H_
#define _ACTUATOR_CONTROLS_PUBSUBTYPES_H_
...
#error Generated actuator_controls is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif
...
/*!
 * @brief This class represents the TopicDataType of the type actuator_controls defined by the user in the IDL file.
 * @ingroup ACTUATOR_CONTROLS
 */
class actuator_controlsPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef actuator_controls type;

    eProsima_user_DllExport actuator_controlsPubSubType();

    eProsima_user_DllExport virtual ~actuator_controlsPubSubType();
...
#endif // _ACTUATOR_CONTROLS_PUBSUBTYPES_H_