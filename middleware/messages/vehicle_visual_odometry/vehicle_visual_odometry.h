...
const uint8_t vehicle_visual_odometry__COVARIANCE_MATRIX_X_VARIANCE = 0;
const uint8_t vehicle_visual_odometry__COVARIANCE_MATRIX_Y_VARIANCE = 6;
const uint8_t vehicle_visual_odometry__COVARIANCE_MATRIX_Z_VARIANCE = 11;
const uint8_t vehicle_visual_odometry__COVARIANCE_MATRIX_ROLL_VARIANCE = 15;
const uint8_t vehicle_visual_odometry__COVARIANCE_MATRIX_PITCH_VARIANCE = 18;
const uint8_t vehicle_visual_odometry__COVARIANCE_MATRIX_YAW_VARIANCE = 20;
const uint8_t vehicle_visual_odometry__COVARIANCE_MATRIX_VX_VARIANCE = 0;
const uint8_t vehicle_visual_odometry__COVARIANCE_MATRIX_VY_VARIANCE = 6;
const uint8_t vehicle_visual_odometry__COVARIANCE_MATRIX_VZ_VARIANCE = 11;
const uint8_t vehicle_visual_odometry__COVARIANCE_MATRIX_ROLLRATE_VARIANCE = 15;
const uint8_t vehicle_visual_odometry__COVARIANCE_MATRIX_PITCHRATE_VARIANCE = 18;
const uint8_t vehicle_visual_odometry__COVARIANCE_MATRIX_YAWRATE_VARIANCE = 20;
const uint8_t vehicle_visual_odometry__LOCAL_FRAME_NED = 0;
const uint8_t vehicle_visual_odometry__LOCAL_FRAME_FRD = 1;
const uint8_t vehicle_visual_odometry__LOCAL_FRAME_OTHER = 2;
const uint8_t vehicle_visual_odometry__BODY_FRAME_FRD = 3;
...
public:
     ...
     */
    eProsima_user_DllExport void q_offset(const vehicle_visual_odometry__float_array_4 &_q_offset);

    /*!
     * @brief This function moves the value in member q_offset
     * @param _q_offset New value to be moved in member q_offset
     */
    eProsima_user_DllExport void q_offset(vehicle_visual_odometry__float_array_4 &&_q_offset);

    /*!
     * @brief This function returns a constant reference to member q_offset
     * @return Constant reference to member q_offset
     */
    eProsima_user_DllExport const vehicle_visual_odometry__float_array_4& q_offset() const;

    /*!
     * @brief This function returns a reference to member q_offset
     * @return Reference to member q_offset
     */
    eProsima_user_DllExport vehicle_visual_odometry__float_array_4& q_offset();
    /*!
     ...
     */
    eProsima_user_DllExport void pose_covariance(const vehicle_visual_odometry__float_array_21 &_pose_covariance);
     ...
     */
    eProsima_user_DllExport void pose_covariance(vehicle_visual_odometry__float_array_21 &&_pose_covariance);
     ...
     */
    eProsima_user_DllExport const vehicle_visual_odometry__float_array_21& pose_covariance() const;

    /*!
     * @brief This function returns a reference to member pose_covariance
     * @return Reference to member pose_covariance
     */
    eProsima_user_DllExport vehicle_visual_odometry__float_array_21& pose_covariance();
    /*!
     ...
     */
    eProsima_user_DllExport void velocity_covariance(const vehicle_visual_odometry__float_array_21 &_velocity_covariance);
     ...
     */
    eProsima_user_DllExport void velocity_covariance(vehicle_visual_odometry__float_array_21 &&_velocity_covariance);
     ...
     */
    eProsima_user_DllExport const vehicle_visual_odometry__float_array_21& velocity_covariance() const;
...
private:
    ...
    vehicle_visual_odometry__float_array_4 m_q_offset;
    vehicle_visual_odometry__float_array_21 m_pose_covariance;
