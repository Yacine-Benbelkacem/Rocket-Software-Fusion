% RocketSolver - a fast solver generated by FORCESPRO v6.0.1
%
%   OUTPUT = RocketSolver(PARAMS) solves a multistage problem
...
%
%   [OUTPUT, EXITFLAG] = RocketSolver(PARAMS) returns additionally
...
%
%   [OUTPUT, EXITFLAG, INFO] = RocketSolver(PARAMS) returns 
