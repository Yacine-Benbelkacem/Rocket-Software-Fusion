 ...
 *    C++ source code generated on : 13-Mar-2023 15:50:02
 *
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        __dtBusInfo[9] = 143*__dtSizeInfo[2];
        ...
        __dtBusInfo[11] = 30*__dtSizeInfo[2];
        ...
        __dtBusInfo[13] = 110*__dtSizeInfo[2];
        ...
        __dtBusInfo[16] = ssGetBusElementOffset(S, __ACADOinputId, 0);
        __dtBusInfo[17] = __dtSizeInfo[1];

        /* Get information for accessing ACADOinput.shifting */
        __dtBusInfo[18] = ssGetBusElementOffset(S, __ACADOinputId, 1);
        __dtBusInfo[19] = __dtSizeInfo[1];

        /* Get information for accessing ACADOinput.initialization */
        __dtBusInfo[20] = ssGetBusElementOffset(S, __ACADOinputId, 2);
        __dtBusInfo[21] = __dtSizeInfo[1];

        /* Get information for accessing ACADOinput.data.x */
        __dtBusInfo[22] = ssGetBusElementOffset(S, __ACADOinputId, 3) + ssGetBusElementOffset(S, __ACADOdataId, 0);
        __dtBusInfo[23] = 143*__dtSizeInfo[2];

        /* Get information for accessing ACADOinput.data.u */
        __dtBusInfo[24] = ssGetBusElementOffset(S, __ACADOinputId, 3) + ssGetBusElementOffset(S, __ACADOdataId, 1);
        __dtBusInfo[25] = 30*__dtSizeInfo[2];

        /* Get information for accessing ACADOinput.data.y */
        __dtBusInfo[26] = ssGetBusElementOffset(S, __ACADOinputId, 3) + ssGetBusElementOffset(S, __ACADOdataId, 2);
        __dtBusInfo[27] = 110*__dtSizeInfo[2];

        /* Get information for accessing ACADOinput.data.yN */
        __dtBusInfo[28] = ssGetBusElementOffset(S, __ACADOinputId, 3) + ssGetBusElementOffset(S, __ACADOdataId, 3);
        __dtBusInfo[29] = 7*__dtSizeInfo[2];
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        (void) memcpy(&__u1BUS[0].control, u1 +  __dtBusInfo[16],  __dtBusInfo[17]);
        (void) memcpy(&__u1BUS[0].shifting, u1 +  __dtBusInfo[18],  __dtBusInfo[19]);
        (void) memcpy(&__u1BUS[0].initialization, u1 +  __dtBusInfo[20],  __dtBusInfo[21]);
        (void) memcpy(__u1BUS[0].data.x, u1 +  __dtBusInfo[22],  __dtBusInfo[23]);
        (void) memcpy(__u1BUS[0].data.u, u1 +  __dtBusInfo[24],  __dtBusInfo[25]);
        (void) memcpy(__u1BUS[0].data.y, u1 +  __dtBusInfo[26],  __dtBusInfo[27]);
        (void) memcpy(__u1BUS[0].data.yN, u1 +  __dtBusInfo[28],  __dtBusInfo[29]);
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    {
        uint32_T chk[] = {3125455009, 1293555123, 2287549939, 3148013370};
        int_T status;
    ...
    {
        uint32_T chk[] = {3811477921, 2401231083, 2027536057, 1899295292};
        int_T status;
    ...
    {
        uint32_T chk[] = {3933600466, 3510975670, 789374482, 3411830639};
        int_T status;
