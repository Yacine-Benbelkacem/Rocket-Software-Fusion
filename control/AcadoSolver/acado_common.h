...
/** Matrix of size: 4 x 221 (row major format) */
real_t rk_kkk[ 884 ];
...
/** Matrix of size: 130 x 3 (row major format) */
real_t evGu[ 390 ];
...
/** Matrix of size: 13 x 11 (row major format) */
real_t QN2[ 143 ];

/** Column vector of size: 122 */
real_t conAuxVar[ 122 ];

/** Row vector of size: 16 */
real_t conValueIn[ 16 ];

/** Row vector of size: 85 */
real_t conValueOut[ 85 ];

/** Column vector of size: 50 */
real_t evH[ 50 ];

/** Matrix of size: 50 x 13 (row major format) */
real_t evHx[ 650 ];
...
/** Matrix of size: 715 x 3 (row major format) */
real_t E[ 2145 ];
...
/** Matrix of size: 140 x 30 (row major format) */
real_t A[ 4200 ];
